...
function BirdPage({ playlist, currentSong, addSong, playNext, playPrev, playSpecificSong, currentIndex }) {
  ...
  useEffect(() => {
    if (birdRef.current) {
      ...
      birdRef.current.play().catch(() => console.log("Background autoplay blocked"));
    }
  }, []);
